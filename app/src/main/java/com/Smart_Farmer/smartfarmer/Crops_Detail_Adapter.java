...
public class Crops_Detail_Adapter extends FirebaseRecyclerAdapter<Add_Crops_Infromation_Model, Crops_Detail_Adapter.myViewHelper> {

    HelperClass helperClass = new HelperClass();

    public Crops_Detail_Adapter(@NonNull FirebaseRecyclerOptions<Add_Crops_Infromation_Model> options) {
        super(options);
    }
    ...
    public Crops_Detail_Adapter.myViewHelper onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_row_crop_details, parent, false); //return view
        return new Crops_Detail_Adapter.myViewHelper(view);
    }

    @Override
    protected void onBindViewHolder(@NonNull Crops_Detail_Adapter.myViewHelper holder, @SuppressLint("RecyclerView") int position, @NonNull Add_Crops_Infromation_Model model) {
        ...
        holder.tv_CropNameEng.setOnClickListener(view -> {
            helperClass.expandable(holder.relativeLayout, holder.tv_CropDetails_ENG, holder.tv_CropDetails_SINDHI, holder.tv_CropNameEng, holder.tv_CropNameSin);
            holder.tv_CropNameEng.setTextColor(Color.parseColor("#008305"));
            holder.tv_CropNameSin.setTextColor(Color.parseColor("#FFFFFF"));
        ...
        holder.tv_CropNameSin.setOnClickListener(view -> {
            ...
            holder.tv_CropNameSin.setTextColor(Color.parseColor("#008305"));
            holder.tv_CropNameEng.setTextColor(Color.parseColor("#FFFFFF"));
